				...
				series: [
					{
						name: "Number of Trades",
						type: "bar",
						data: this.profitLossDistribution.data.map((value, index) => {
							const isLoss = this.profitLossDistribution.labels[index].includes("-");
